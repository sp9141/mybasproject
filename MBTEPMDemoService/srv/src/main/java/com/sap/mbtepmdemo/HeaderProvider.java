...
public class HeaderProvider extends com.sap.mbtepmdemo.base.HeaderProviderBase {
    ...
    public static StringSet initPropagate() {
        StringSet propagate = com.sap.mbtepmdemo.base.HeaderProviderBase.initPropagate();
